...
class ShamanATriggerFactoryInternal : public NamedObjectContext<Trigger>
{
    public:
        ShamanATriggerFactoryInternal()
        {
            ...
            creators["elemental mastery"] = &ShamanATriggerFactoryInternal::elemental_mastery;//bug宕机
    ...
    private:
        ...
        static Trigger* elemental_mastery(PlayerbotAI* botAI) { return new ElementalMasteryTrigger(botAI); }//bug宕机
...
class ShamanAiObjectContextInternal : public NamedObjectContext<Action>
{
    public:
        ShamanAiObjectContextInternal()
        {
            ...
            creators["elemental mastery"] = &ShamanAiObjectContextInternal::elemental_mastery;//BUG宕机
    ...
    private:
        ...
        static Action* elemental_mastery(PlayerbotAI* botAI) { return new CastElementalMasteryAction(botAI); }//bug宕机
