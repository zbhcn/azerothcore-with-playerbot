...
namespace Acore::Hyperlinks
{
    ...
    struct ItemLinkData
    {
        ...
        //std::vector<int32> RandomPropertyIds;  // 存储多个randomPropertyId
        //std::vector<ItemRandomPropertiesEntry const*> RandomProperties;  // 存储多个RandomProperties
        //std::vector<ItemRandomSuffixEntry const*> RandomSuffixes;        // 存储多个RandomSuffixes
